...
if __name__ == "__main__":
    subject = "My Python EmailUtil Test"
    from_addr = "13825012292@139.com"
    to_list = ["568824204@qq.com","zabbixonlytest@163.com"]
    cc_list = ["1492604006@qq.com",]
    smtpserver = "smtp.139.com"
    username = "13825012292"
    password = "china2009"
    eu = EMailUtil(subject,from_addr,to_list,cc_list)
    eu.addMessage("<div>走,吃饭去!!!</div>"+eu.defaultsign,type="html")
    # eu.addMessageFromFile("~/桌面/1.jpg",type="image",cid="img1")
    eu.addAttach(["~/桌面/1.jpg",])
    eu.sendmail(smtpserver,username,password)
